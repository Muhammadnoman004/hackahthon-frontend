            ...
            render: (_, record) => (
                <Space size="small">
                    <div className='flex justify-between items-center gap-2'>
                        ...
                        <Link to={"/trainer/:classId/:assignmentId/submissions"}><button className='text-sm text-white bg-teal-600 p-2 rounded-md hover:bg-teal-700'>View Submissions</button></Link>
